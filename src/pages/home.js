...
//       primary: {
//         main: darkMode ? 'rgb(0, 200, 160)' : 'rgb(0, 46, 37)',
//         light: darkMode ? 'rgb(51, 230, 190)' : 'rgb(51, 97, 88)',
//         dark: darkMode ? 'rgb(0, 150, 120)' : 'rgb(0, 23, 18)',
//       },
//       secondary: {
//         main: 'rgb(255, 193, 7)',
//       },
//       background: {
//         default: darkMode ? '#121212' : '#f0f4f4',
//         paper: darkMode ? '#1e1e1e' : '#ffffff',
//       },
//       text: {
//         primary: darkMode ? 'rgb(255, 255, 255)' : 'rgb(0, 46, 37)',
//         secondary: darkMode ? 'rgb(178, 178, 178)' : 'rgb(102, 102, 102)',
//       },
//     },
//     typography: {
//       fontFamily: '"Inter", "Roboto", "Helvetica", "Arial", sans-serif',
...
//       },
//       text: {
//         primary: darkMode ? 'rgb(240, 240, 240)' : 'rgb(0, 46, 37)',
//         secondary: darkMode ? 'rgb(200, 200, 200)' : 'rgb(102, 102, 102)',
//       },
//     },
//     typography: {
//       fontFamily: '"Inter", "Roboto", "Helvetica", "Arial", sans-serif',
...
//   width: '100%',
//   maxWidth: 340,
//   backgroundColor: theme.palette.mode === 'dark' ? 'rgb(30, 60, 50)' : theme.palette.background.paper,
//   borderRadius: theme.spacing(2),
//   overflow: 'hidden',
//   transition: 'transform 0.3s ease-in-out, box-shadow 0.3s ease-in-out',
//   border: `2px solid ${theme.palette.primary.light}`,
...
//     transform: 'translateY(-8px)',
//     boxShadow: theme.palette.mode === 'dark'
//       ? '0 12px 20px rgba(0, 200, 160, 0.2)'
...
//   marginBottom: theme.spacing(2),
//   fontWeight: 700,
//   color: theme.palette.mode === 'dark' ? 'rgb(0, 200, 160)' : theme.palette.primary.main,
// }));
